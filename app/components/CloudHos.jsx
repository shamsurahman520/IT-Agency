...
const CloudHos = () => {
  ...
  return (
   <section className="flex flex-col lg:flex-row gap-12 mt-6 py-28 max-sm:py-12 md:px-16 sm:px-10 lg:px-0.5  mx-auto bg-[#F6F3F3]">
